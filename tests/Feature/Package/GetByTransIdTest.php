...
class GetByTransIdTest extends TestCase
{
    ...
    public function test_it_can_get_package_by_trans_id(): void
    {
        ...
        $this->service->shouldReceive("getByTransId")->andReturn($packageData);


        $response = $this->getJson(uri:route('getPackageByID',$packageData->transaction_id),headers:$this->header);
    ...
    public function test_it_cannot_get_package_if_some_error_occurs(): void
    {
        ...
        $this->service->shouldReceive("getByTransId")->andThrow(new Exception("some error occurs"));
     ...
     * A basic feature test example.
     */
    public function test_it_cannot_get_package_if_not_found(): void
    {
        $this->service->shouldReceive("getByTransId")->andThrow(ModelNotFoundException::class);
        $response = $this->getJson(uri:route('getPackageByID',"test"),headers:$this->header);
