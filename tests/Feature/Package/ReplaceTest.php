...
class ReplaceTest extends TestCase
{
    ...
    public function test_it_can_replace_package(): void
    {
        ...
        $this->service->shouldReceive("replace")->andReturn($packageData);

        $url = route("replacePackage",$packageData->transaction_id);

        $response = $this->putJson(data:$requestData,uri:$url,headers:$this->header);
     ...
     * A basic feature test example.
     */
    public function test_it_cannot_replace_package_if_validation_error(): void
    {
        $packageData = Package::factory()->create();
        $requestData = $this->createRequestData();
        ...
        $response = $this->putJson(data:$requestData,uri:route('replacePackage',$packageData->transaction_id),headers:$this->header);
     ...
     * A basic feature test example.
     */
    public function test_it_cannot_replace_package_if_some_error_occurs(): void
    {
        $packageData = Package::factory()->create();
        $requestData = $this->createRequestData();
    ...
    public function test_it_cannot_replace_package_if_not_found(): void
    {
        $packageData = Package::factory()->create();
        $requestData = $this->createRequestData();
        
        $this->service->shouldReceive("replace")->andThrow(ModelNotFoundException::class);
