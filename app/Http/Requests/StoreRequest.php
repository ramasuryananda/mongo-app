...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            "connote" => "required|array:connote_number,connote_service,connote_code,connote_booking_code,connote_order,connote_state_id,zone_code_from,zone_code_to,surcharge_amount,actual_weight,volume_weight,chargeable_weight,connote_total_package,connote_surcharge_amount,connote_sla_day,location_name,location_type,source_tariff_db,id_source_tariff,pod,history",
            ...
            "origin_data" => 'required|array:customer_name,customer_address,customer_email,customer_phone,customer_address_detail,customer_zip_code,zone_code',
            "origin_data.customer_name"=> 'required|string',
            "origin_data.customer_address"=> 'required|string',
            "origin_data.customer_email"=> 'required|string',
            ...
            "destination_data" => 'required|array:customer_name,customer_address,customer_email,customer_phone,customer_address_detail,customer_zip_code,zone_code',
            "destination_data.customer_name"=> 'required|string',
            "destination_data.customer_address"=> 'required|string',
            "destination_data.customer_email"=> 'required|string',
            ...
            "koli_data.*" => 'nullable|array:koli_length,awb_url,koli_chargeable_weight,koli_width,koli_surcharge,koli_height,koli_description,koli_formula_id,koli_volume,koli_weight,koli_custom_field,koli_code',
